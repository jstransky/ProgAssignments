...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        private void SpawnBear()
        {
            ...
            xLocation = GetRandomLocation(GameConstants.SpawnBorderSize, GameConstants.WindowWidth - GameConstants.SpawnBorderSize);
            yLocation = GetRandomLocation(GameConstants.SpawnBorderSize, GameConstants.WindowHeight - GameConstants.SpawnBorderSize);

            // generate random velocity
            speed = GameConstants.MinBearSpeed + RandomNumberGenerator.NextFloat(GameConstants.MinBearSpeed);
            ...
            // create new bear
            newBear = new TeddyBear(Content, @"graphics\teddybear", xLocation, yLocation, velocity, null, null);
